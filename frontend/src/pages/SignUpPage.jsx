              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm opacity-70">
                    Join Fluently and start your realtime language learning journey.
                  </p>
                </div>
          ...
          <div className="max-w-md p-8">
            ...
            <div className="relative aspect-square max-w-sm mx-auto rounded-2xl overflow-hidden border border-base-300/70">
              <img
                ...
                alt="Language learners in conversation"
                className="w-full h-full object-cover"
              />
            </div>

            <div className="text-center space-y-3 mt-6">
              <h2 className="text-xl font-semibold">Build fluency through real conversations</h2>
              <p className="opacity-70">
                Meet native speakers, make friends, and practice every day with live chat and calls.
              </p>
            </div>
          </div>
        </div>
